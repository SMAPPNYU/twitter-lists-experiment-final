...
output_td <- map(c("w3_belief_accuracy_ittcii", 
              ...
              bootstrapping_estimate(models, .x)) 
...
save_function("h1_truth_discernment_restricted.png")
...
save_function("h1_consp_belief_restricted.png")
...
# svae
plot_ml 
save_function("h2_misinformation_literacy_restricted.png")
...
# save
plot_pol
save_function("h3_polarization_restricted.png")
...
#save
plot_media
save_function("h4_media_trust_restricted.png")
...
# save
plot_polcyn
save_function("h5_political_cynicism_restricted.png")
...
# save
plot_soccyn
save_function("h6_social_media_cyn_restricted.png")
...
# save
plot_ability
save_function("h7_ability_misinfo_restricted.png")
...
write_csv(full_data, here("output", "pilot", "all_results.csv"))  
...
save_function(paste0(str_replace(str_to_lower(full_data$outcome[i]), " ", "_"), "_viz2.png"))
